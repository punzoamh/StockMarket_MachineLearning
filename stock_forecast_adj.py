...
def main():
    ...
    while(i < 39):
        ...
        2009,2009,2008,2008,2007,2007,2007,2006,2006,2006,2005])
        ...
        title = 'scores/accuracy_' + str(days2[i]) + '.txt'
        text_file = open(title, "w")
        text_file.write('Dates from ' + str(days2[i]) + ' Days\n 50 Days Prediction Accuracy\n')
        training_date = datetime.datetime(yr2[i],mo2[i],dy2[i])
        makePrediction(training_date,days2[i])
        i += 1
        print i
